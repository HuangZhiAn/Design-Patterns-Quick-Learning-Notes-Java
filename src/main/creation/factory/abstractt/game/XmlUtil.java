...
public class XmlUtil {
    ...
    public static ControllerFactory getControllerBean(){
        ...
        try {
            document = reader.read("src/main/creation/factory/abstractt/game/config.xml");
        ...
        try {
            ControllerFactory = (ControllerFactory) Class.forName("creation.factory.abstractt.game."+node.getText()).newInstance();
